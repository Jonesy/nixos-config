...
static const char *dimcmd[] = { "brightnessctl", "set", "5%-", NULL };
static const char *brightencmd[] = { "brightnessctl", "set", "5%+", NULL };
...
static const Key keys[] = {
  ...
  { 0,                         XKB_KEY_XF86MonBrightnessUp,  spawn,  {.v = brightencmd } },
